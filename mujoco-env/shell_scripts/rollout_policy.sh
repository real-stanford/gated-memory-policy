...
# python_path=$(conda info --base)/envs/robomimic39/bin/python
# python_path=python
...
additional_args=""
# additional_args=$additional_args" task.judge.time_limit_s=30.0"
# additional_args=$additional_args" task.env.env_name=square"
# additional_args=$additional_args" task.use_viewer=false"
# additional_args=$additional_args" task.show_camera_images=false"

command="$python_path scripts/rollout_policy.py $task_name policy_server_port=$policy_server_port $additional_args"
